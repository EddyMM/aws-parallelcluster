...
from pcluster.templates.cdk_assets_manager import CDKAssetsUploadManager
...
class CDKTemplateBuilder:
    ...
    def build_cluster_template(
        ...
        with tempfile.TemporaryDirectory() as cloud_assembly_dir:
            ...
            cdk_assets_manager = CDKAssetsUploadManager(str(cloud_assembly_dir))
            assets_metadata = cdk_assets_manager.upload_assets(stack_name=stack_name, bucket=bucket)
